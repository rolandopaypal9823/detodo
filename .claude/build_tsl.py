...
@media(max-width:980px){
  ...
  /* en celular la franja de 220px dejaba celdas de 152x108: una foto vertical
     perdia la mitad. Con proporcion cuadrada las celdas quedan casi cuadradas
     y el recorte baja mucho, sea cual sea la orientacion de la foto. */
  .incl-feature__photo{min-height:0;aspect-ratio:1/1;max-height:78vh;border-left:0;border-top:1px dashed var(--hair-2);order:-1}
...
@media(max-width:640px){
  ...
  /* el boton fijo de arriba medía 37px: por debajo de los 44px que necesita un dedo */
  .btn-sm{min-height:44px;padding:12px 20px}
  /* la letra chica legal y los roles del equipo eran ilegibles en mano */
  .feat-legal{font-size:12px;line-height:1.65}
